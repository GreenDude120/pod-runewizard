...
var Runewords = [
	...
	{ title: "Leaf", runes: ['Tir','Ral'], ttype:"Staves" },
	...
	{ title: "Memory", runes: ['Lum','Io','Sol','Eth'], ttype:"Staves" },
	...
	{ title: "Doom", runes: ['Hel','Ohm','Um','Lo','Cham'], ttype:"Axes/Polearms/Hammers/Spears" },
	...
	{ title: "Insight", runes: ['Ral','Tir','Tal','Sol'], ttype:"Polearms/Staves/Bows/Spears", ladder:true },
	...
	{ title: "Rift", runes: ['Hel','Ko','Lem','Gul'], ttype:"Polearms/Scepters/Spears", ladder:true },
	...
	/* POD LADDER */
    { title: "Pattern", runes: ['Tal','Ort','Tir'], ttype:"Claws", ladder:true },
    { title: "Pattern2", runes: ['Tal','Ort','Thul'], ttype:"Claws", ladder:true },
    { title: "Plague", runes: ['Cham','Fal','Um'], ttype:"Weapons", ladder:true },
    { title: "Plague2", runes: ['Cham','Shael','Um'], ttype:"Swords/Claws/Daggers", ladder:true },
	/* D2R */
    { title: "Bulwark", runes: ['Shael','Io','Sol'], ttype:"Helms", ladder:true },
    { title: "Cure", runes: ['Shael','Io','Tal'], ttype:"Helms", ladder:true },
    { title: "Flickering Flame", runes: ['Nef','Pul','Vex'], ttype:"Helms", ladder:true },
    { title: "Ground", runes: ['Shael','Io','Ort'], ttype:"Helms", ladder:true },
    { title: "Hearth", runes: ['Shael','Io','Thul'], ttype:"Helms", ladder:true },
    { title: "Hustle", runes: ['Shael','Ko','Eld'], ttype:"Weapons/Body Armor", ladder:true },
    ...
    { title: "Wisdom", runes: ['Pul','Ith','Eld'], ttype:"Helms", ladder:true },
